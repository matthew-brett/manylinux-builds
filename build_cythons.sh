...
# or:
#    docker run --rm -e CYTHON_VERSIONS=0.23.4 -e PYTHON_VERSIONS=2.7 -v $PWD:/io quay.io/pypa/manylinux1_x86_64 /io/build_cythons.sh
#
...
if [ -z $CYTHON_VERSIONS ]; then
    CYTHON_VERSIONS="0.17 0.17.1 0.17.2 0.17.3 0.17.4 0.18 \
        ...
        0.23 0.23.1 0.23.2 0.23.3 0.23.4 0.23.5 0.24"
fi
